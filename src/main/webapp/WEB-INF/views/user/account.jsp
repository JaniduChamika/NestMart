<%-- 
    Document   : account
    Created on : Feb 27, 2025, 11:54:12 PM
    Author     : ROG STRIX
--%>
...
<!--                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#" role="button" onclick="logout()">Sign Out</a>
                                    </li>
                                </ul>
                            </aside><!-- End .col-lg-3 -->

                            <div class="col-md-8 col-lg-9" style="flex:0 0 75% ;max-width: 75%">
                                            ...
                                            <c:when test="${orders!=null}">
                                                <table class="table table-wishlist table-mobile">
                                                    <thead>
                                                        <tr>
                                                            <th>Product</th>
                                                            <th class="text-center pl-3 pr-3">Quantity</th>
                                                            <th class="pl-3 pr-3">Total Price</th>
                                                            <th>Status</th>
                                                            <th></th>
                                                        ...
                                                        <c:forEach var="order" items="${orders}">
                                                            <c:forEach var="item" items="${order.orderItems}">
                                                                ...
                                                                <tr>
                                                                    <td class="product-col">
                                                                        <div class="product">
                                                                            <figure class="product-media">
                                                                                <a href="product?pid=${item.product.id}">
                                                                    ...
                                                                    <td class="price-col"> ${currency} <fmt:formatNumber value="${item.product.price}" pattern="###,###.00" /></td>
                                                                    <td class="text-center">
                                                                        ${item.status}

                                                                    </td>
                                                                    <td class="action-col pl-5 ">
                                                                        <button class="btn btn-outline-secondary " data-product-id="${item.product.id}">Cancel</button>
                                                                    </td>
