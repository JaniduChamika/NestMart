...
<layout:extends name="vendor">
    <layout:put block="pluginCSS" type="REPLACE">
        <link rel="stylesheet" href="${base_url}pro-assets/vendors/datatables.net-bs4/dataTables.bootstrap4.css">
        <link rel="stylesheet" href="${base_url}pro-assets/js/select.dataTables.min.css">
    </layout:put>
    <layout:put block="pluginJS" type="REPLACE">
        <script src="${base_url}pro-assets/vendors/chart.js/Chart.min.js"></script>
        <script src="${base_url}pro-assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js"></script>
        <script src="${base_url}pro-assets/vendors/progressbar.js/progressbar.min.js"></script>
    </layout:put>
    <layout:put block="customJS" type="REPLACE">
     
        <script src="${base_url}pro-assets/js/Chart.roundedBarCharts.js"></script>
