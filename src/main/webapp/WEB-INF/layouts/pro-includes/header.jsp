    ...
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
            <a class="navbar-brand brand-logo" href="${base_url}seller">
                <img src="${base_url}pro-assets/images/logo.png" alt="logo" />
            </a>
    ...
    <div class="navbar-menu-wrapper d-flex align-items-top">
        <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                <h1 class="welcome-text">Hello!, <span class="text-black fw-bold">${vendor.businessName}</span></h1>
            ...
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                    <div class="dropdown-header text-center">
                        ...
                        <p class="mb-1 mt-3 font-weight-semibold">${vendor.businessName}</p>
                        <p class="fw-light text-muted mb-0">${vendor.businessEmail}</p>
                    </div>
                    ...
                    <a class="dropdown-item"><i class="dropdown-item-icon mdi mdi-help-circle-outline text-primary me-2"></i>
                        FAQ</a>
                    <a class="dropdown-item" href="${base_url}"><i class="dropdown-item-icon mdi mdi-swap-horizontal text-primary me-2"></i>Switch to User</a>
